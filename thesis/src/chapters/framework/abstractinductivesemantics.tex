...
\end{definition}
  ...
  \todo[inline]{Ma è ben definito $C^\fix$?, servirebbe la semantica monotona
    per avere l'esistenza di ogni lfp}
...
%           &\text{By theorem \ref{thm:lfp-order}}\\
%           &= \asem{C^\fix}(Q) 
%           &\text{By definition of $\asem{C^\fix}$}\\
%       \end{align*}
% 
...
\subsection{Galois connection semantics}
  ...
  \todo[inline]{Basterebbe soundess dei comandi base, più serve a qualcosa?}
